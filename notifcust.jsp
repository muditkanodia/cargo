<%-- 
    Document   : notifcust
    Created on : Sep 3, 2017, 12:19:27 PM
    Author     : Mudit
--%>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="alert alert-info alert-with-icon" data-notify="container">
                                    ...
                                    <span data-notify="message">Hello Customer!! Welcome to our  courier service of 24x7 Couriers. Happy Couriering!!</span>
                                </div>
                                
                                <div class="alert alert-info alert-with-icon" data-notify="container">
                                    <button type="button" aria-hidden="true" class="close">×</button>
                                    <span data-notify="icon" class="pe-7s-bell"></span>
                                    <span data-notify="message">We hope you will enjoy our service.</span>
                                </div>
                            </div>
