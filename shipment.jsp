                                   ...
                                   <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="dd/mm/yyyy" class="form-control" id="inputField" name="pdate"><a href="javascript:void(0)" onclick="displayCalendar('inputField', 'dd/mm/yyyy', this)"><img  src="cimages/calendar.gif"/></a>
                                            </div>
                                        </div>
                                    </div>
                                   <div class="row">
