<%-- 
    Document   : entertrackingdetail
    Created on : Sep 2, 2017, 1:43:45 AM
    Author     : Mudit
--%>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                               ...
                               <form action="entertrackingdetaildb.jsp" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="shipid">
                                            </div>
                                        </div>
                                    </div>
                                   <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Shipment Location/Description</label>
