...
<div class="wrapper">
 ...
 <h3 style="margin-left: 30px;">Welcome Delivery Boy!!</h3>
 <div <h3 style="margin-left: 30px; color: gray;">
         <p><br></p>
 <p>Hello  Member...<br></p>
 <p>We are so pleased to have you in our family.<br></p>
 <p>We hope you will serve us well and always be the integrated part of 24x7 couriers<br></p>
 <p>Here are some of the functionalities of this interface:<br></p>
 <p>Enter Tracking Detail<br></p>
 
 <p>View<br></p><p><br></p>
 <P>In case you forget your random password then please contact the Admin.<br></p>
 </div>
