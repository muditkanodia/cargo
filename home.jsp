                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-lg-3">
                            <div class="logo">
                                <a href="index.html"><img src="logo_cargo.png" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="email_us s_header">
                                ...
                                <p class="uppercase">help@24x7couriers.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-5 col-lg-5 col-sm-6 col-xs-12">
                                            <div class="top_quate_text text-center">
                                               <div class="quate_text_overlay"></div>
                                                ...
                                                <a class="top_quate_action" href="custreg1.jsp">SIGN  UP</a>
                                             </div>
                                         </div>
                                    </div>
                                </div>
											...
											<li><a href="#">Pages</a>
												<ul>
													...
													<li><a href="404.html">not found</a></li>
                                                                                        ...
                                                                                        <li><a href="log_1.jsp">login</a></li>
											<li><a href="blog.html">Blog</a></li>
											<li><a href="storage-location.html">Team</a></li>
											<li><a href="contact-us.html">Contact Us</a></li>
											<li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-8">
                        <div class="signup_form">
                            ...
                            <form action="trackdb.jsp">    
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        <input type="text" name="shipid" placeholder="Your Order No." required >
                                    ...
                                    <p class="text-left"><button type="submit" >Track</button></p>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="single_blog">
                            <div class="blog_img">
                                <a href=""><img src="img/blog_1.jpg" alt=""></a>
                                <div class="blog_date">
                            ...
                            <div class="blog_content">   
                                ...
                                <h3><a href="#">Makin their way the only way they know how</a></h3>
                                <p>we're gonna make our dream come true. Were gonna do it. Give us any chance well take it. Give us any rule we'll break it.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="single_blog">
                            ...
                            <div class="blog_content">   
                                <p class="blog_name">By/John Smith</p>
                                <h3><a href="#">Guys like us we had it made Those were the days</a></h3>
                                <p>Friendly neighbors there that's where we meet. Can you tell me how to get how to get to Sesame Street. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="single_blog">
                            <div class="blog_img">
                                <a href=""><img src="img/blog_3.jpg" alt=""></a>
                                <div class="blog_date">
                                    <p class="Blog_month">24 <span>June</span></p>
                                    <p class="blog_year">2015</p>
                                </div>
                            ...
                            <div class="blog_content">   
                                <p class="blog_name">By/John Smith</p>
                                <h3><a href="#">Lovely lady who was bringing up three lovely girls</a></h3>
                                <p>Love exciting and new. Come aboard were expecting you. Love life's sweetest reward Let it flow it floats back to you. </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row footer_padding_top">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="footer_email_us s_footer">
                                ...
                                <p>muditkanodia@gmail.com <br>Help@fctransport.com</p>
                             </div>
                        </div>
                    </div>
                    <div class="row">
