<%-- 
    Document   : dboyview
    Created on : Sep 2, 2017, 1:57:56 AM
    Author     : Mudit
--%>
...
<body>
                ...
                <% 
                String fname="",lname="",email="",desig="",add1="",add2="",mob="",qua="",dcity="",dstate="";
     ...
     try{
        String Query = "select * from deliveryboy where email ='" +email+"' ";
          ...
          dcity = rs.getString(5);
            ...
            add1=rs.getString(8)+", "+rs.getString(9);
            add2=rs.getString(11)+", "+rs.getString(10)+", "+rs.getString(12);
            mob=rs.getString(14);
            qua=rs.getString(15);
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                               ...
                               <form action="dboy.jsp" method="post">
