<%-- 
    Document   : createdboy
    Created on : Aug 22, 2017, 7:00:07 PM
    Author     : Mudit
--%>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                               ...
                               <form action="createdboydb.jsp" method="post">
                                   ...
                                   <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Type</label>
                                                <input type="text" class="form-control" value="Delivery Boy" >
                                            </div>
                                        </div>
                                    </div>
                                   ...
                                   <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="dcity">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="dstate">
                                            </div>
                                        </div>
                                    </div>
