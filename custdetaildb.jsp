...
<html>
    ...
    <body>
        <%String email = (String)session.getAttribute("email");
         ...
         // PreparedStatement ps = null;
         PreparedStatement ps=  con.prepareStatement("update custregisteration set house='"+house+"' where email='"+email+"'");ps.executeUpdate();
           ps= con.prepareStatement("update custregisteration set locality='"+locality+"' where email='"+email+"'");ps.executeUpdate();
        ps=  con.prepareStatement("update custregisteration set pin='"+pin+"' where email='"+email+"'");ps.executeUpdate();
        ps=  con.prepareStatement("update custregisteration set city='"+city+"' where email='"+email+"'");ps.executeUpdate();
        ps=  con.prepareStatement("update custregisteration set state='"+state+"' where email='"+email+"'");ps.executeUpdate();
         ps= con.prepareStatement("update custregisteration set country='"+coun+"' where email='"+email+"'");ps.executeUpdate();
         ps=con.prepareStatement("update custregisteration set mob='"+mob+"' where email='"+email+"'");ps.executeUpdate();
